					...
					<div class="row-fluid">
						<form class="form-horizontal" action="<?php echo site_url($base."/tambah_aksi"); ?>" method="POST" autocomplete="off"/>
							<div class="control-group">
								<label class="control-label" for="form-field-1">Nama Keterangan</label>

								<div class="controls">
									<input type="text" class="span12" id="form-field-1" name="nama" placeholder="Nama Keterangan" required/>
								</div>
							</div>
