<div class="row-fluid">
    <div class="span12">
        ...
        <div class="control-group <?= form_error('penyelenggara') ? 'error' : ''; ?>">
            ...
            <div class="controls">
                <input type="text" name="penyelenggara" id="penyelenggara" placeholder="Penyelenggara" value="<?php echo set_value('penyelenggara'); ?>" class="span5" autofocus />
        ...
        <div class="control-group <?= form_error('tempat') ? 'error' : ''; ?>">
            ...
            <div class="controls">
                <input type="text" name="tempat" id="tempat" placeholder="Tempat" value="<?php echo set_value('tempat'); ?>" class="span5" />
        ...
        <div class="control-group <?= form_error('tanggal') ? 'error' : ''; ?>">
            ...
            <div class="controls">
                <div class="row-fluid input-append">
                    <input class="date-picker" name="tanggal" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" value="<?php echo set_value('tanggal'); ?>" placeholder="Tanggal" />
                    <span class="add-on">
        ...
        <div class="control-group <?= form_error('lama') ? 'error' : ''; ?>">
            ...
            <div class="controls">
                <input type="text" class="input-mini" name="lama" value="<?= set_value('lama', '1'); ?>" />
        ...
        <div class="control-group <?= form_error('dari_jam') ? 'error' : ''; ?>">
            ...
            <div class="controls">
                <div class="input-append bootstrap-timepicker">
                    <input id="dari_jam" type="text" name="dari_jam" class="input-small timepicker" value="<?= set_value('dari_jam'); ?>" />
                    <span class="add-on">
                        <i class="icon-time"></i>
                    </span>
                </div>
        ...
        <div class="control-group <?= form_error('sampai_jam') ? 'error' : ''; ?>">
            ...
            <div class="controls">
                <div class="input-append bootstrap-timepicker">
                    <input id="sampai_jam" type="text" name="sampai_jam" class="input-small timepicker" value="<?= set_value('sampai_jam', null); ?>" />
                    <span class="add-on">
                        <i class="icon-time"></i>
                    </span>
                </div>
        ...
        <div class="control-group <?= form_error('keterangan') ? 'error' : ''; ?>">
            ...
            <div class="controls">
                <?php
                echo $this->ckeditor->editor("keterangan", html_entity_decode(set_value('keterangan', '')), "");
                ?>
