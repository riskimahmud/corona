					...
					<div class="row-fluid">
						<form class="form-horizontal" action="<?php echo site_url($base."/tambah_aksi"); ?>" method="POST" enctype="multipart/form-data" autocomplete="off"/>
							...
							<div class="control-group">
								...
								<div class="controls">
									<?php
										echo $this->ckeditor->editor("isi","","required");
									?>
								</div>
							</div>
				...
				<div class="widget-main">
					<div class="row-fluid">
						<form class="form-horizontal" action="<?php echo site_url($base."/perbarui_aksi"); ?>" method="POST" enctype="multipart/form-data" autocomplete="off"/>
							<input type="hidden" class="span12" id="form-field-1" name="id" value="<?php echo $row->id_hoax; ?>"/>
							<div class="control-group">
								<label class="control-label">Gambar</label>
							...
							<div class="control-group">
								...
								<div class="controls">
									<?php
										echo $this->ckeditor->editor("isi",$row->isi,"required");
									?>
								</div>
							</div>
							<div class="control-group">
						...
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><span class="label label-<?php echo $label; ?>"><?php echo $msg; ?></span></td>
									<td><?php echo tgl_indonesia($d->create_at); ?></td>
									<td>
										<a class="btn btn-inverse btn-mini" href="?a=edit&id=<?php echo $d->id_hoax; ?>">Edit</a>
										<a class="btn btn-danger btn-mini" href="<?php echo site_url($base."/hapus/".$d->id_hoax); ?>" onclick="return confirm('Apakah anda yakin?')">Hapus</a>
									</td>
								</tr>
								<?php
									$no++;
