                        ...
                        <div class="widget-main">
                            <div class="row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span4" name="nama_puskesmas" placeholder="Nama" required />
                                    </div>
                                </div>
                        ...
                        <div class="widget-main">
                            <div class="row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span4" name="nama_puskesmas" placeholder="Nama" value="<?php echo $row->nama_puskesmas; ?>" required />
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <button type="submit" class="btn btn-small btn-inverse">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-inverse btn-mini" href="?a=edit&id=<?php echo $d->id_puskesmas; ?>">Edit</a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
