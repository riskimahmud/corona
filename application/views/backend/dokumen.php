					...
					<div class="row-fluid">
						<form class="form-horizontal" action="<?php echo site_url($base."/tambah_aksi"); ?>" method="POST" enctype="multipart/form-data" autocomplete="off"/>
							<div class="control-group">
								...
								<div class="controls">
									<input type="file" class="span12" name="dokumen" placeholder="Pilih File" accept=".PDF" required/>
								</div>
							</div>
							<div class="control-group">
				...
				<div class="widget-main">
					<div class="row-fluid">
						<form class="form-horizontal" action="<?php echo site_url($base."/perbarui_aksi"); ?>" method="POST" enctype="multipart/form-data" autocomplete="off"/>
							<input type="hidden" class="span12" id="form-field-1" name="id" value="<?php echo $row->id_dokumen; ?>"/>
							<div class="control-group">
								<label class="control-label">File</label>
						...
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a class="btn btn-inverse btn-mini" href="?a=edit&id=<?php echo $d->id_dokumen; ?>">Edit</a>
										<a class="btn btn-danger btn-mini" href="<?php echo site_url($base."/hapus/".$d->id_dokumen); ?>" onclick="return confirm('Apakah anda yakin?')">Hapus</a>
									</td>
								</tr>
								<?php
									$no++;
